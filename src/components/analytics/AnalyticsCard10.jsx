    ...
    datasets: [
      {
        ...
        backgroundColor: [
          `rgba(${hexToRGB(tailwindConfig().theme.colors.slate[500])}, 0.8)`,
          `rgba(${hexToRGB(tailwindConfig().theme.colors.slate[400])}, 0.8)`,
          `rgba(${hexToRGB(tailwindConfig().theme.colors.gray[500])}, 0.8)`,
        ],
        hoverBackgroundColor: [
          `rgba(${hexToRGB(tailwindConfig().theme.colors.slate[600])}, 0.8)`,
          `rgba(${hexToRGB(tailwindConfig().theme.colors.slate[500])}, 0.8)`,
