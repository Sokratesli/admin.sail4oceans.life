  ...
  const chartData = {
    ...
    datasets: [
      // Stack
      {
        ...
        backgroundColor: tailwindConfig().theme.colors.slate[700],
        hoverBackgroundColor: tailwindConfig().theme.colors.slate[800],
        barPercentage: 0.66,
      ...
      // Stack
      {
        ...
        backgroundColor: tailwindConfig().theme.colors.slate[500],
      ...
      // Stack
      {
        ...
        hoverBackgroundColor: tailwindConfig().theme.colors.slate[200],
        barPercentage: 0.66,
        categoryPercentage: 0.66,
      },
    ],
